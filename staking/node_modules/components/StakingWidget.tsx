...
const STAKING_ADDRESS = "0xYOUR_STAKING_CONTRACT"; // <-- set me after deploy
...
export default function StakingWidget() {
    ...
    try {
      ...
      if (chainId !== SEPOLIA_CHAIN_ID_HEX) {
        try {
          ...
          // If chain not added, user can add it manually in MetaMask
  ...
  // Load user balances/earned + wallet DDB balance
  ...
  async function ensureAllowance(poolId: number, tokenAmount: string) {
  ...
  async function doStake() {
    ...
    try {
      await ensureAllowance(selectedPool, tokenAmount);
      setPending("Staking...");
